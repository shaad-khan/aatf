...
public class BuildingAddHoursOfOperationPageTest extends BasePageTest {
  ...
  public void BuildingAddHoursOfOperation() {	  
	  try {
	        ...
	        page.GetInstance(BuildingAddHoursOfOperationPage.class).BuildingAddHoursOfOperation();
